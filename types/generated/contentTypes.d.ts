...
export interface ApiBookingBooking extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bookingContent: Schema.Attribute.Component<'content.overview', false> &
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::booking.booking'
    >;
    locationAvailability: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiConfigurationConfiguration extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    datesDisabled: Schema.Attribute.Component<'content.date-disabled', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    maxNoOfChild: Schema.Attribute.Integer &
      Schema.Attribute.Required &
...
export interface ApiDashboardDashboard extends Struct.SingleTypeSchema {
  ...
  attributes: {
    checkedList: Schema.Attribute.Component<'content.checked-list', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    faqContent: Schema.Attribute.Component<'content.overview', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    galleryContent: Schema.Attribute.Component<'content.overview', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    nanniesContent: Schema.Attribute.Component<'content.overview', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    nanniesProfileContent: Schema.Attribute.Component<
      'content.overview',
      false
    > &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiLanguageLanguage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    nannies: Schema.Attribute.Relation<'manyToMany', 'api::nanny.nanny'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNannyNanny extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::nanny.nanny'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPackagePackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currencyCode: Schema.Attribute.Enumeration<['AED', 'SAR']>;
    groups: Schema.Attribute.Component<'content.package-group', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::package.package'
